...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Nov 2023 pada 07.02
...
(1, 'SHOBARUDIN', 'Pria', 'sleman', '083874723607'),
(2, 'ozi', 'Pria', 'sleman', '083874723607');
...
CREATE TABLE `pengguna` (
  ...
  `notelpn` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pengguna` (`id`, `username`, `password`, `email`, `notelpn`) VALUES
(4, 'admin', '$2y$10$RltYRSy0z/H2/6W6DVRbuu5WE9h58jXaWvo7eU6dbdg0/qwqISFNW', 'admin@gmail.com', '082320093601');
...
(1, 'AB5273UJ', 'Pupuk K69', '1', 1, '20000', 0, '1'),
(2, 'AB5273UJ1', 'Pupuk OKI', '1', 1, '50000', 9, '1');
...
CREATE TABLE `stok_masuk` (
  ...
  `supplier` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, '2023-11-15 11:52:26', 1, '1', 'penambahan', NULL),
(2, '2023-11-15 12:08:10', 2, '10', 'penambahan', '1');
...
(1, 'SHOBARUDIN', 'sleman', '083874723607', 'blblabaa'),
(2, 'adi', 'jogja', '0832393383', 'blbalabla');
...
CREATE TABLE `transaksi` (
  ...
  `pelanggan` varchar(11) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, '2023-11-15 11:52:58', '1', '1', '20000', '30000', '', '1', 'WVC425XBLVKI90H', 1),
(2, '2023-11-15 12:08:24', '2', '1', '50000', '60000', '', '1', 'YYC7AAZM06EYOOY', 1);
