    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col">
              <p class="text-center" style="font-weight: bold; line-height: 1;">KASIRQ</p>
              <p class="text-center">Gamping, Sleman Yogyakarta</p>
              <p class="text-center" style="line-height: 1;">Telpn 083874723607</p>
              <h1 class="m-1 text-dark">Laporan Stok Keluar</h1>
            </div>
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
