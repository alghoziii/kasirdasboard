<!-- <style>
  .main-sidebar.sidebar-light-success {
    background-color: #02472E imp;
  }
</style> -->
<!-- Main Sidebar Container -->
<aside class="main-sidebar sidebar-light-success elevation-4">
  <!-- Brand Logo -->
  <a href="<?php echo site_url('') ?>" class="brand-link text-center" style="color: #02472E;">
    <span class="brand-text font-bold-light"><?php echo $this->session->userdata('toko')->nama ?></span>
  </a>
